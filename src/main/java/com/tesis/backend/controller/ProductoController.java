...
import com.tesis.backend.service.ProductoService;
...
import  com.tesis.backend.service.CategoriaService;
import com.tesis.backend.service.UnidadService;
...
public class ProductoController {
    ...
    public ResponseEntity<ProductDTO> addStockProduct(@PathVariable Long id,
                                                      ...
                                                      @RequestParam Double cantidad,
                                                      @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime fechaMovimiento){
        ProductDTO disabledProduct = productService.addStockProduct(id,productDTO, idUsuario, tipoMovimiento, cantidad, fechaMovimiento);
        return ResponseEntity.ok(disabledProduct); // Envía la respuesta con estado 200 y el producto desactivado
    }
    ...
    public ResponseEntity<?> createProduct(@RequestBody ProductDTO productDTO,
        ...
        try {
            ...
            movimiento.setProducto(savedProduct);
