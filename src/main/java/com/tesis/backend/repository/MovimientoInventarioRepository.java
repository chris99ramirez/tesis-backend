...
public interface MovimientoInventarioRepository extends JpaRepository<MovimientoInventario, Integer> {
    @Query("SELECT new com.tesis.backend.dto.MovimientoInventarioDTO(m.idMovimiento, m.tipoMovimiento, m.cantidad, m.fechaMovimiento) FROM MovimientoInventario m WHERE m.producto.idProducto = :idProducto")
