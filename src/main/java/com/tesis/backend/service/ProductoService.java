...
public class ProductoService {
    ...
    @Transactional
    public ProductDTO addStockProduct(Long id,ProductDTO productDTO, Integer idUsuario, Integer tipoMovimiento, Double cantidad, LocalDateTime fechaMovimiento){
        Product product = productRepository.findById(id).orElseThrow(() -> new RuntimeException("Product not found with id " + id));
